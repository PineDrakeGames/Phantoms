...
public class GameDataSaver : PixelCrushers.Saver
{
    ...
    {
        SaveDataManager.SavedData = PixelCrushers.SaveSystem.Deserialize<SavedGameData>(data);
        SaveDataManager.UpdateStaticData();
    }
