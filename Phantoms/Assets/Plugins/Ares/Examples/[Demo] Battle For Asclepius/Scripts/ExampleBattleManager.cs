...
namespace Ares.Examples {
	public class ExampleBattleManager : MonoBehaviour {
		[SerializeField, Header("Battle")] BattleRules rules = null;
		[SerializeField] List<Actor> friendlyActors = null;
		[SerializeField] List<Actor> enemyActors = null;
		[SerializeField] BattleDelayElement[] battleDelayElements = null;
		[SerializeField, Header("Dynamic Actor")] bool spawnErebus = false;
		[SerializeField] GameObject erebusPrefab = null;
		[SerializeField] AbilityData[] erebusAbilityData = null;
		[SerializeField] AudioClip erebusHitSound = null;
		[SerializeField, Header("UI References")] Text[] eventTexts = null;
		[SerializeField] AbilityButton[] abilityButtons = null;
		[SerializeField] ItemButton[] itemButtons = null;
		[SerializeField] TargetButton[] targetButtons = null;
		[SerializeField] Button itemButton = null;
		[SerializeField] Button backButton = null;
		[SerializeField] Image abilitiesMask = null;
		[SerializeField] Image targetsMask = null;
		[SerializeField] Image itemsMask = null;
		[SerializeField] RectTransform actorNamePanel = null;
		[SerializeField] Image endBattleOverlay = null;
		[SerializeField] Text endBattleText = null;
		[SerializeField, Header("UI Controls")] float eventTextScrollSpeed = 0f;
		[SerializeField] float eventTextHoldTime = 0f;
		[SerializeField] float endBattleFadeTime = 0f;
		[SerializeField] float endBattleTextGrowTime = 0f;
		[SerializeField, Header("UI Appearance")] Gradient abilityButtonTargetColors = null;
		[SerializeField] Color endBattleFadeColor = Color.white;
		[SerializeField] Color abilityButtonAttackColor = Color.white;
		[SerializeField] Color abilityButtonHealColor = Color.white;
		[SerializeField] Color abilityButtonBuffColor = Color.white;
		[SerializeField] Color abilityButtonEnvironmentColor = Color.white;
		[SerializeField] Sprite abilityButtonAttackIcon = null;
		[SerializeField] Sprite abilityButtonHealIcon = null;
		[SerializeField] Sprite abilityButtonBuffIcon = null;
		[SerializeField] Sprite abilityButtonEnvironmentIcon = null;
		[SerializeField, Header("Audio")] AudioClip uiSuccess = null;
		[SerializeField] AudioClip uiFail = null;
		[SerializeField, Header("Environment")] Transform cloudsParent = null;
		[SerializeField] Light sunLight = null;
		[SerializeField] WindZone wind = null;
...
//			actor.OnItemRecoveryStart.AddListener((item, message) => ShowEventText(message));
		...
		void SpawnErebus(){
			...
			animationCallbackDie.Effect.SetAsAnimationDelay(0);
