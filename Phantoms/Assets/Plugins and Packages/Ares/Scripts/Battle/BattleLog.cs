...
namespace Ares
{
    public class BattleLog : MonoBehaviour
    {
        ...
        public void AddBattleListeners(Battle battle)
        {
            ...
            battle.OnAfflictionResults.AddListener(AfflictionResult);
        }
        ...
        private void AfflictionResult(Actor actor, AfflictionResults results)
        {
            string log = string.Format("Processing affliction {1} on {0}.", actor.DisplayName, results.affliction.Data.DisplayName);
            AddLog(log);
        }
    }
}