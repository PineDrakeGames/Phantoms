...
public class TestMinigame : AbilityMinigame
{
    ...
    {
        m_minigameAnim.SetInteger("Step", 0);
        m_currentTime = 0f;
        m_currentStep = 0;
    ...
    protected override void InitializingState()
    {
        ...
        if (m_animatorState.IsName("Enter") && m_animatorState.normalizedTime >= 0.95)
        {
            m_minigameAnim.ResetTrigger("Start");
    ...
    protected override void RunningState()
    {
        ...
        if (Input.GetKeyUp(KeyCode.Space))
        {
            ...
            m_minigameAnim.SetTrigger("Finish");
