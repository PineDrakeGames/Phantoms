...
Shader "MicroSplat"
{
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "HDLitShader" "Queue" = "Geometry+100" "IgnoreProjector" = "False" "SplatCount" = "4"}
...
#if _URP
sampler2D _MainTex; // for unity 2020.3 bug
#endif
    ...
    void SurfaceFunction(inout Surface o, inout ShaderData d)
    {
        ...
        o.Alpha = l.Alpha;
         ...
         ShaderData CreateShaderData(VertexToPixel i)
         {
            ...
            #endif
            // d.localSpaceNormal = normalize(mul(GetWorldToObjectMatrix(), i.worldNormal));
            // d.localSpaceTangent = normalize(mul(GetWorldToObjectMatrix(), i.worldTangent.xyz));
...
float3 GetTessFactors ()
{
    ...
    void SurfaceFunction(inout Surface o, inout ShaderData d)
    {
        ...
        o.Alpha = l.Alpha;
         ...
         ) : SV_Target
         {
           ...
           return float4(PackNormalOctRectEncode(TransformWorldToViewDir(mul(l.Normal, d.TBNMatrix), true)), 0.0, 0.0);
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat_Base1497918919"
   Fallback "Hidden/MicroSplat_Base1497918919"
